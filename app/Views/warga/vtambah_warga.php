                ...
                <div class="card-body">
                    <form action="/warga/save" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="date" value="yyyy-mm-dd" id="tgl" name="tgl">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="date" value="yyy-mm-dd" id="tpk" name="tpk">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="paspor" name="paspor">
                        </div>
                        <div class="form-group">
                            <label for="kitap">No. KITAP</label>
                            <input type="text" class="form-control" id="kitap" name="kitap">
                        </div>
                        <div class="form-group">
